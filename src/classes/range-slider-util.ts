import {
  getRangeSliderOptionsFromData,
  IRangeSliderOptions
} from "../interfaces/range-slider-options"
...
export class RangeSliderUtil {
  ...
  public static mergeConfigurations(baseConfiguration: IRangeSliderOptions<number | string>, newConfiguration?: Partial<IRangeSliderOptions<number | string>>, updateCheck?: {
        from: number;
        to: number;
    }): IRangeSliderOptions<number> {
  ...
  private static checkConfiguration(configuration: IRangeSliderOptions<number>, updateCheck?: {
        from: number;
        to: number;
    }): IRangeSliderOptions<number> {
  ...
  private static convertToConfiguration(configuration: Partial<IRangeSliderOptions<number | string>>, data: DOMStringMap | undefined): Partial<IRangeSliderOptions<number | string>> {
    if (data === undefined || Object.keys(data).length === 0) {
      return configuration
    }
    return { ...configuration, ...getRangeSliderOptionsFromData(data) }
  }
}
